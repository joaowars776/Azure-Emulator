...
namespace Azure.Updater
{
    public class Main
    {
        ...
        public void CheckUpdates()
        {
            ...
            this.thisversion = fvi.FileVersion;
            info = Update.getUpdateInfo(this.downloadUrl, this.versionfilename, string.Format("{0}{1}", Application.StartupPath, @"\"), 1);
            ...
            {
                if (decimal.Parse(info[1]) > decimal.Parse(this.thisversion))
                {

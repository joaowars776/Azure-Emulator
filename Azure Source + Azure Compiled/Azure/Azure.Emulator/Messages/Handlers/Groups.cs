...
namespace Azure.Messages.Handlers
{
    ...
    internal partial class GameClientMessageHandler
    {
        ...
        internal void SerializeGroupPurchaseParts()
        {
            ...
            this.Response.AppendInteger(global::Azure.Azure.GetGame().GetGroupManager().Bases.Count);
            foreach (GroupBases current in global::Azure.Azure.GetGame().GetGroupManager().Bases)
            {
                this.Response.AppendInteger(current.Id);
                this.Response.AppendString(current.Value1);
                this.Response.AppendString(current.Value2);
            }
            this.Response.AppendInteger(global::Azure.Azure.GetGame().GetGroupManager().Symbols.Count);
            foreach (GroupSymbols current2 in global::Azure.Azure.GetGame().GetGroupManager().Symbols)
            {
            ...
            this.Response.AppendInteger(global::Azure.Azure.GetGame().GetGroupManager().BaseColours.Count);
            foreach (GroupBaseColours current3 in global::Azure.Azure.GetGame().GetGroupManager().BaseColours)
            {
                this.Response.AppendInteger(current3.Id);
                this.Response.AppendString(current3.Colour);
            }
            this.Response.AppendInteger(global::Azure.Azure.GetGame().GetGroupManager().SymbolColours.Count);
            foreach (GroupSymbolColours current4 in global::Azure.Azure.GetGame().GetGroupManager().SymbolColours.Values)
            {
                this.Response.AppendInteger(current4.Id);
                this.Response.AppendString(current4.Colour);
            }
            this.Response.AppendInteger(global::Azure.Azure.GetGame().GetGroupManager().BackGroundColours.Count);
            foreach (GroupBackGroundColours current5 in global::Azure.Azure.GetGame().GetGroupManager().BackGroundColours.Values)
            {
        ...
        internal void SerializeGroupInfo()
        {
            ...
            Guild group = global::Azure.Azure.GetGame().GetGroupManager().GetGroup(groupId);
            if (group == null)
                return;
            global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupInfo(group, this.Response, this.Session, newWindow);
        }
        ...
        internal void SerializeGroupMembers()
        {
            ...
            global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupMembers(this.Response, group, reqType, this.Session, searchVal, page);
            this.SendResponse();
        }
        ...
        internal void MakeGroupAdmin()
        {
            ...
            Guild group = global::Azure.Azure.GetGame().GetGroupManager().GetGroup(num);
            ...
            this.Response.Init(LibraryParser.OutgoingRequest("GroupMembersMessageComposer"));
            global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupMembers(this.Response, group, 1u, this.Session, "", 0);
            this.SendResponse();
            Room room = global::Azure.Azure.GetGame().GetRoomManager().GetRoom(group.RoomId);
            if (room != null)
            {
                RoomUser roomUserByHabbo = room.GetRoomUserManager().GetRoomUserByHabbo(global::Azure.Azure.GetHabboById(num2).UserName);
            ...
            using (IQueryAdapter queryReactor = global::Azure.Azure.GetDatabaseManager().GetQueryReactor())
            {
        ...
        internal void RemoveGroupAdmin()
        {
            ...
            this.Response.Init(LibraryParser.OutgoingRequest("GroupMembersMessageComposer"));
            global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupMembers(this.Response, group, 0u, this.Session, "", 0);
            this.SendResponse();
            Room room = global::Azure.Azure.GetGame().GetRoomManager().GetRoom(group.RoomId);
            if (room != null)
            {
        ...
        internal void AcceptMembership()
        {
            ...
            group.Admins.Add(num2, group.Members[num2]);
            global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupInfo(group, this.Response, this.Session, false);
            this.Response.Init(LibraryParser.OutgoingRequest("GroupMembersMessageComposer"));
            global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupMembers(this.Response, group, 0u, this.Session, "", 0);
            this.SendResponse();
            using (IQueryAdapter queryreactor2 = global::Azure.Azure.GetDatabaseManager().GetQueryReactor())
            {
        ...
        internal void RemoveMember()
        {
            ...
            if (num2 == this.Session.GetHabbo().Id)
            {
                ...
                if (this.Session.GetHabbo().FavouriteGroup == num)
                {
                    ...
                    {
                        RoomUser roomUserByHabbo = global::Azure.Azure.GetGame().GetRoomManager().GetRoom(group.RoomId).GetRoomUserManager().GetRoomUserByHabbo(global::Azure.Azure.GetHabboById(num2).UserName);
                        if (roomUserByHabbo == null)
                            return;
                        roomUserByHabbo.RemoveStatus("flatctrl 1");
                        this.Response.Init(LibraryParser.OutgoingRequest("RoomRightsLevelMessageComposer"));
            ...
            global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupMembers(this.Response, group, 0u, this.Session, "", 0);
            this.SendResponse();
            using (IQueryAdapter queryreactor3 = global::Azure.Azure.GetDatabaseManager().GetQueryReactor())
            {
        ...
        {
            if ((global::Azure.Azure.GetUnixTimeStamp() - this.Session.GetHabbo().LastSqlQuery) < 20)
                return;
            uint groupId = this.Request.GetUInteger();
            ...
            if (group == null || !group.HasForum)
                return;
            int timestamp = global::Azure.Azure.GetUnixTimeStamp();
            using (IQueryAdapter dbClient = global::Azure.Azure.GetDatabaseManager().GetQueryReactor())
            {
                if (threadId != 0)
                {
                    ...
                    {
                        this.Session.SendNotif(Azure.GetLanguage().GetVar("forums_cancel"));
                        return;
                    }
                }
                this.Session.GetHabbo().LastSqlQuery = global::Azure.Azure.GetUnixTimeStamp();
            ...
            if (threadId == 0)
            {
                ...
                Message.AppendBool(false);
                Message.AppendInteger((global::Azure.Azure.GetUnixTimeStamp() - timestamp));
        ...
        internal void UpdateThreadState()
        {
            ...
            using (IQueryAdapter dbClient = global::Azure.Azure.GetDatabaseManager().GetQueryReactor())
            {
                ...
                Message.AppendInteger((global::Azure.Azure.GetUnixTimeStamp() - Thread.Timestamp));
        ...
        internal void ReadForumThread()
        {
            ...
            using (IQueryAdapter dbClient = global::Azure.Azure.GetDatabaseManager().GetQueryReactor())
            {
                ...
                foreach (GroupForumPost Post in posts)
                {
                    ...
                    Message.AppendInteger((global::Azure.Azure.GetUnixTimeStamp() - Post.Timestamp));
        ...
        internal void GetGroupForums()
        {
            ...
            switch (SelectType)
            {
                ...
                case 1:
                    using (IQueryAdapter dbClient = global::Azure.Azure.GetDatabaseManager().GetQueryReactor())
                    {
                        ...
                        while (i <= b)
                        {
                            ...
                            Guild Guild = global::Azure.Azure.GetGame().GetGroupManager().GetGroup(GroupId);
                ...
                case 2:
                    ...
                    {
                        Guild AGroup = global::Azure.Azure.GetGame().GetGroupManager().GetGroup(GU.GroupId);
                        if (AGroup == null)
                            continue;
        ...
        internal void UpdateGroupName()
        {
            ...
            global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupInfo(group, this.Response, this.Session, this.Session.GetHabbo().CurrentRoom, false);
        }
        ...
        internal void UpdateGroupBadge()
        {
            ...
            Guild guild = global::Azure.Azure.GetGame().GetGroupManager().GetGroup(guildId);
            if (guild != null)
            {
                Room room = global::Azure.Azure.GetGame().GetRoomManager().GetRoom(guild.RoomId);
                if (room != null)
                {
                    ...
                    string badge = global::Azure.Azure.GetGame().GetGroupManager().GenerateGuildImage(Base, baseColor, guildStates);
                    guild.Badge = badge;
                    this.Response.Init(LibraryParser.OutgoingRequest("RoomGroupMessageComposer"));
                    ...
                    global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupInfo(guild, this.Response, this.Session, room, false);
                    using (IQueryAdapter queryReactor = global::Azure.Azure.GetDatabaseManager().GetQueryReactor())
                    {
                    ...
                    if (this.Session.GetHabbo().CurrentRoom != null)
                    {
                        ...
                        this.Session.GetHabbo().CurrentRoom.SendMessage(this.Response);
                        global::Azure.Azure.GetGame().GetGroupManager().SerializeGroupInfo(guild, this.Response, this.Session, this.Session.GetHabbo().CurrentRoom, false);
                    }
                }
            }
        }
        ...
        internal void ConfirmLeaveGroup()
        {
            ...
            uint UserId = this.Request.GetUInteger();
            Guild byeGuild = global::Azure.Azure.GetGame().GetGroupManager().GetGroup(Guild);
            if (byeGuild == null)
                return;
            else if (byeGuild.CreatorId == UserId)
            {
                this.Session.SendNotif(Azure.GetLanguage().GetVar("user_room_video_true"));
                return;
            }
            int type = 3;
            if (UserId == this.Session.GetHabbo().Id || byeGuild.Admins.ContainsKey(this.Session.GetHabbo().Id))
            {
                ...
                HabboHotel.Users.Habbo byeUser = global::Azure.Azure.GetHabboById(UserId);
                if (byeUser != null)
                {

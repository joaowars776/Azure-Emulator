...
namespace Azure
{
    ...
    public static class Azure
    {
        ...
        internal static void TimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            Console.WriteLine();
            Out.WriteLine(
                string.Format("Console Cleared in: {0} Next Time on: {1} Seconds ", DateTime.Now, ConsoleTimer),
                "Azure.Boot", ConsoleColor.DarkGreen);
            Console.WriteLine();
            GC.Collect();
            Timer.Start();
        }
        ...
        internal static void Initialize()
        {
            ...
            try
            {
                ...
                //StartOutgoing = true;
                if (ConsoleTimerOn) Out.WriteLine("Console Clear Timer is Enabled, with " + ConsoleTimer + " Seconds.", "Azure.Boot");
                ...
                if (LibraryParser.Config["Crypto.Enabled"] == "true")
                {
                    ...
                    Out.WriteLine("The encryption system is disabled. This affects badly to the safety.",
                        "Azure.Crypto", ConsoleColor.DarkYellow);
                ...
                var allowedIps = ConfigurationData.Data["mus.tcp.allowedaddr"].Split(';');
            ...
            catch (Exception e)
            {
                Out.WriteLine(
                    ...
                    "Azure.Boot", ConsoleColor.Red);
                Out.WriteLine("Please press Y to get more details or press other Key to Exit", "Azure.Boot",
                    ConsoleColor.Red);

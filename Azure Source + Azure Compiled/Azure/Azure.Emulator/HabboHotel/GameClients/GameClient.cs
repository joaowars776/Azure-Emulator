...
namespace Azure.HabboHotel.GameClients
{
    ...
    public class GameClient
    {
        ...
        internal void HandlePublicist(string word, string message, string method, Security.BlackWordTypeSettings settings)
        {
            ...
            if (GetHabbo().Rank < 5 && settings.MaxAdvices == PublicistCount++ && settings.AutoBan)
            {
                ...
                serverMessage.AppendString("Mensagem do Filtro");
                serverMessage.AppendString("message");
                serverMessage.AppendString("- " + GetHabbo().UserName + " foi banido pelo filtro anti-divulgação!");
            ...
            serverMessage.AppendString("title");
            serverMessage.AppendString("Ops! Pare de fazer isto.");
            serverMessage.AppendString("message");

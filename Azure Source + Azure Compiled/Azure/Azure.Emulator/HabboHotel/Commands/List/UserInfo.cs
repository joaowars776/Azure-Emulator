    ...
    internal sealed class UserInfo : Command
    {
        ...
        public override bool Execute(GameClient session, string[] pms)
        {
            ...
            if (clientByUserName == null || clientByUserName.GetHabbo() == null)
            {
                ...
                {
                    adapter.SetQuery(
                        "SELECT username, rank, id, credits, activity_points, seasonal_currency FROM users WHERE username=@user LIMIT 1");
            ...
            session.SendNotif(string.Concat("User info for: ", userName, " \rUser ID: ", habbo.Id, ":\rRank: ", habbo.Rank, "\rCurrentTalentLevel: ", habbo.CurrentTalentLevel, " \rCurrent Room: ", habbo.CurrentRoomId, " \rCredits: ", habbo.Credits, "\rDuckets: ", habbo.ActivityPoints, "\rDiamonds: ", habbo.BelCredits, "\rMuted: ", habbo.Muted.ToString(), "\r\r\r", builder.ToString()));

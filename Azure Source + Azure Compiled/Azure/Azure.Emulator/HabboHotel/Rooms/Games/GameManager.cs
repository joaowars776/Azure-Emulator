...
namespace Azure.HabboHotel.Rooms.Games
{
    internal class GameManager
    {
            ...
            foreach (
                var result in
                    _yellowTeamItems.Values.Where(
                        current4 => current4.GetBaseItem().InteractionType == Interaction.FreezeYellowCounter)) return result;
            IL_151:
            return null;
        }
        ...
        internal Room GetRoom() { return _room; }
        ...
        private int GetScoreForTeam(Team team) { return TeamPoints[(int) team]; }

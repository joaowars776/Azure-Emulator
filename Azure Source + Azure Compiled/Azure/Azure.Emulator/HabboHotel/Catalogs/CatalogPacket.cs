...
namespace Azure.HabboHotel.Catalogs
{
    ...
    internal static class CatalogPacket
    {
                                                 ...
                                                 int limitedSelled = 0)
        {
            ...
            message.AppendInteger(belsCost);
        ...
        internal static void ComposeItem(CatalogItem item, ServerMessage message)
        {
            ...
            {
                message.AppendInteger(item.BelCreditsCost);
                message.AppendInteger(105);
            }
            else if (item.LoyaltyCost > 0)
            {
                message.AppendInteger(item.LoyaltyCost);
                message.AppendInteger(105);
            }
            else
            {
            ...
            foreach (var baseItem in item.Items.Keys)
            {
                ...
                else if (item.Name == "room_ad_plus_badge")
                {
                    message.AppendString("");
                    message.AppendInteger(0);
                }

var WebStore = {
  ...
  _setPreviewItem: function() {
    ...
    pre.className = currItem.previewCssClass + " " + currItem.type;
...
WebStore.Inventory = {
  ...
  selectCategory: function(type, categoryEl) {
    ...
    if (type && type != 'null' && WebStore.Inventory.selectedCategory != type && categoryEl) {
  ...
  _setPreviewItem: function() {
    ...
    pre.className = WebStore.Inventory.previewItem[0] + " " + WebStore.Inventory.previewItem[3];

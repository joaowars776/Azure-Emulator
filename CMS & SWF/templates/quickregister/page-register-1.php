...
<meta name="keywords" content="habbo hotel, mundo, virtual, rede social, livre, comunidade, caráter, bate-papo, online, teen, roleplaying, participar de grupos sociais, fóruns, seguros, jogar, jogos, amigos, adolescentes, mobili, raros raros, colecionáveis, criar, coletar, conectar, mobili, móveis, mobiliário, design de interiores, de compartilhamento, de expressão, placas, asa, visitas de celebridades, música, celebridades, celebridades, jogos online, jogos multiplayer, multiplayer massa" />
...
<div id="stepnumbers">
    <div class="step1focus">Aniversário e Sexo</div>
...
<div id="alert-javascript-container">
    ...
    <div id="alert-javascript-text">
        ...
        Javascript está desativado em seu navegador. Por favor habilite JavaScript ou você atualizar seu navegador para uma versão com javascript para utilizar <?php echo $shortname; ?> :)
...
<div id="alert-cookies-container" style="display:none">
    ...
    <div id="alert-cookies-text">
        ...
        Seu navegador não está configurado para aceitar cookies. Por favor, permita o uso de "cookies", para usar <?php echo $shortname; ?>.
...
<?php } ?>
    ...
    <form id="quickregisterform" method="post" action="<?php echo $path; ?>/quickregister/age_gate_submit">
        ...
        <div id="title">     Aniversário e Sexo</div>

        <div id="date-selector">
            <h3>Por favor, indique a data de nascimento válida</h3>
